<template>
  <div class="init-wrapper">
    ...
    <a-card-meta title="初始化RDS账户" style="textAlign: center" description="你需要创建一个账户用以后续登录管理RDS"/>
    <br/>
    ...
    introGuide() {
      if (this.getGuideFlag) {
        this.$introJs().setOptions({
          ...
          steps: [ {
            title: '导航小助手',
            intro: '哎呀，出现这个页面表示你没有设置系统管理员信息，或者需要重置管理员信息'
          }, {
            title: '导航小助手',
            element: document.querySelector('.login-card'),
            intro: '此处需要填写的信息是用以管理 RDS 系统的系统管理员的账户密码，一定要记住哦，它是登录 RDS 的唯一凭证'
          },{
            title: '导航小助手',
