...
public class OutGivingModel extends BaseModel {
	 ...
	 * 主机列表
	 */
	private List<SshModel> sshModelList;
	...
	public List<SshModel> getSshModelList() {
		return sshModelList;
	}

	public void setSshModelList(List<SshModel> sshModelList) {
		this.sshModelList = sshModelList;
	}
