...
public class ServerConfigBean {
	 ...
	 * package信息
	 */
	public static final String PKG_LIST = "package_list.json";

	/**
	 * package信息
	 */
	public static final String PKG_SCRIPT_LIST = "package_script_list.json";


	/**
	 * ssh信息
	 */
	public static final String PKG_HOST_LIST = "package_host_list.json";
